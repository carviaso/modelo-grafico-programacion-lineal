 ...
 */
public class Proyecto_Final_IOView extends FrameView {

    public Proyecto_Final_IOView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = Proyecto_Final_IOApp.getApplication().getMainFrame();
            aboutBox = new Proyecto_Final_IOAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        Proyecto_Final_IOApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(proyecto_final_io.Proyecto_Final_IOApp.class).getContext().getResourceMap(Proyecto_Final_IOView.class);
        fileMenu.setText(resourceMap.getString("fileMenu.text")); // NOI18N
        fileMenu.setName("fileMenu"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(proyecto_final_io.Proyecto_Final_IOApp.class).getContext().getActionMap(Proyecto_Final_IOView.class, this);
